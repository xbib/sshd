...
public enum BuiltinIdentities implements Identity {
    ...
    ECDSA(Constants.ECDSA, org.xbib.io.sshd.common.config.keys.KeyUtils.EC_ALGORITHM, ECPublicKey.class, ECPrivateKey.class) {
        @Override
    ...
    public static final class Constants {
        public static final String RSA = org.xbib.io.sshd.common.config.keys.KeyUtils.RSA_ALGORITHM;
