...
public final class DigestUtils {
     ...
     */
    public static <D extends org.xbib.io.sshd.common.digest.Digest> D findDigestByAlgorithm(String algo, Comparator<? super String> comp, Collection<? extends D> digests) {
    ...
    /**
     * @param f The {@link Factory} to create the {@link org.xbib.io.sshd.common.digest.Digest} to use
     ...
     * @see #getFingerPrint(org.xbib.io.sshd.common.digest.Digest, String, Charset)
     */
    public static String getFingerPrint(Factory<? extends org.xbib.io.sshd.common.digest.Digest> f, String s) throws Exception {
     ...
     * @throws Exception If failed to calculate the digest
     */
    public static String getFingerPrint(Factory<? extends org.xbib.io.sshd.common.digest.Digest> f, String s, Charset charset) throws Exception {
        return getFingerPrint(Objects.requireNonNull(f, "No factory").create(), s, charset);
    }

    /**
     * @param d The {@link org.xbib.io.sshd.common.digest.Digest} to use
     * @param s The {@link String} to digest - ignored if {@code null}/empty,
     *          otherwise its UTF-8 representation is used as input for the fingerprint
     * @return The fingerprint - {@code null} if {@code null}/empty input
     * @throws Exception If failed to calculate the digest
     * @see #getFingerPrint(org.xbib.io.sshd.common.digest.Digest, String, Charset)
     */
    public static String getFingerPrint(org.xbib.io.sshd.common.digest.Digest d, String s) throws Exception {
     ...
     * @throws Exception If failed to calculate the digest
     */
    public static String getFingerPrint(org.xbib.io.sshd.common.digest.Digest d, String s, Charset charset) throws Exception {
     ...
     */
    public static String getFingerPrint(Factory<? extends org.xbib.io.sshd.common.digest.Digest> f, byte... buf) throws Exception {
     ...
     * @throws Exception If failed to calculate the fingerprint
     */
    public static String getFingerPrint(Factory<? extends org.xbib.io.sshd.common.digest.Digest> f, byte[] buf, int offset, int len) throws Exception {
     ...
     * @return The fingerprint - {@code null} if empty data buffer
     * @throws Exception If failed to calculate the fingerprint
     * @see #getFingerPrint(org.xbib.io.sshd.common.digest.Digest, byte[], int, int)
     */
    public static String getFingerPrint(org.xbib.io.sshd.common.digest.Digest d, byte... buf) throws Exception {
     ...
     * @return The fingerprint - {@code null} if non-positive length
     * @throws Exception If failed to calculate the fingerprint
     * @see #getRawFingerprint(org.xbib.io.sshd.common.digest.Digest, byte[], int, int)
     */
    public static String getFingerPrint(org.xbib.io.sshd.common.digest.Digest d, byte[] buf, int offset, int len) throws Exception {
        if (len <= 0) {
            return null;
        }
    ...
    public static byte[] getRawFingerprint(org.xbib.io.sshd.common.digest.Digest d, byte... buf) throws Exception {
