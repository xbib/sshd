package org.xbib.io.sshd.common.util.buffer;
...
public final class BufferUtils {
     ...
     *
     * @param buffer The {@link org.xbib.io.sshd.common.util.buffer.Buffer}
     ...
     */
    public static int updateLengthPlaceholder(org.xbib.io.sshd.common.util.buffer.Buffer buffer, int lenPos) {
     ...
     */
    public static void updateLengthPlaceholder(org.xbib.io.sshd.common.util.buffer.Buffer buffer, int lenPos, int dataLength) {
    ...
    /**
     * Invokes {@link org.xbib.io.sshd.common.util.buffer.Buffer#clear()}
     *
     * @param <B>    The generic buffer type
     * @param buffer A {@link org.xbib.io.sshd.common.util.buffer.Buffer} instance - ignored if {@code null}
