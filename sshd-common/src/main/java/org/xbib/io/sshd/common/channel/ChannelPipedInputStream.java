...
public class ChannelPipedInputStream extends InputStream implements ChannelPipedSink {
    private final org.xbib.io.sshd.common.channel.Window localWindow;
    ...
    public ChannelPipedInputStream(PropertyResolver resolver, org.xbib.io.sshd.common.channel.Window localWindow) {
