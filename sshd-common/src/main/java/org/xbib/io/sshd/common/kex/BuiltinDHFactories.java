...
import org.xbib.io.sshd.common.config.NamedResourceListParseResult;
...
public enum BuiltinDHFactories implements DHFactory {
    ...
    /**
     * Registered a {@link org.xbib.io.sshd.common.NamedFactory} to be available besides the built-in
