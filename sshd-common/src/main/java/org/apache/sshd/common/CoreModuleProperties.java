...
import org.apache.sshd.common.auth.WelcomeBannerPhase;
...
public final class CoreModuleProperties {
    ...
    /**
     * Value that can be set on the {@link FactoryManager} or the session to configure the
     ...
     * {@link Charset} then the local default is used.
     */
