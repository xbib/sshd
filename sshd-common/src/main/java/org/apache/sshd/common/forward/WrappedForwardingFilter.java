 ...
 */
public interface WrappedForwardingFilter extends AgentForwardingFilter, X11ForwardingFilter, TcpForwardingFilter {
    /**
     ...
     */
    static WrappedForwardingFilter asForwardingFilter(
        ...
        return new WrappedForwardingFilter() {
            @Override
