...
public enum BuiltinMacs implements MacFactory {
     ...
     * @return   The matching {@link BuiltinMacs} whose {@link Enum#name()} matches (case
    ...
    /**
     * @param  factory The {@link NamedFactory} for the MAC - ignored if {@code null}
     * @return         The matching {@link BuiltinMacs} whose factory name matches (case
