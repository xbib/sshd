...
import org.xbib.io.sshd.common.util.logging.SimplifiedLog;
...
public class SshKeyScan implements Channel, Callable<Void>, ServerKeyVerifier, SessionListener, SimplifiedLog {
    ...
    private org.xbib.io.sshd.client.SshClient client;
    private int port;
    ...
    public Void call() throws Exception {
        ...
        try {
            ...
            client = org.xbib.io.sshd.client.SshClient.setUpDefaultClient();
    ...
    protected void resolveServerKeys(org.xbib.io.sshd.client.SshClient client, String host,
