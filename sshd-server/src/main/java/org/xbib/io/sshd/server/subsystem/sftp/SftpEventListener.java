...
public interface SftpEventListener extends SshdEventListener {
     ...
     * @param localHandle  The associated file / directory {@link org.xbib.io.sshd.server.subsystem.sftp.Handle}
     * @throws IOException If failed to handle the call
     */
    default void opening(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.Handle localHandle)
            throws IOException {
        // ignored
    }
     ...
     * @throws IOException If failed to handle the call
     */
    default void open(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.Handle localHandle)
            throws IOException {
        // ignored
    }
     ...
     * @param localHandle  The associated {@link org.xbib.io.sshd.server.subsystem.sftp.DirectoryHandle}
     ...
     * @param localHandle  The associated {@link org.xbib.io.sshd.server.subsystem.sftp.FileHandle}
     ...
     * @throws IOException If failed to handle the call
     */
    default void reading(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle,
     ...
     * @throws IOException If failed to handle the call
     */
    default void read(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle,
     ...
     * @throws IOException If failed to handle the call
     */
    default void writing(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle,
     ...
     * @throws IOException If failed to handle the call
     */
    default void written(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle,
     ...
     * @throws IOException If failed to handle the call
     * @see #blocked(ServerSession, String, org.xbib.io.sshd.server.subsystem.sftp.FileHandle, long, long, int, Throwable)
     */
    default void blocking(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle, long offset, long length, int mask)
            throws IOException {
        // ignored
    }
     ...
     * @throws IOException If failed to handle the call
     */
    default void blocked(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle, long offset, long length, int mask, Throwable thrown)
            throws IOException {
        // ignored
    }
     ...
     * @throws IOException If failed to handle the call
     */
    default void unblocking(ServerSession session, String remoteHandle, org.xbib.io.sshd.server.subsystem.sftp.FileHandle localHandle, long offset, long length)
            throws IOException {
        // ignored
    }
