...
public final class SshServerConfigFileReader {
    ...
    public static WrappedForwardingFilter resolveServerForwarding(PropertyResolver options) {
        ...
        return WrappedForwardingFilter.asForwardingFilter(agentFilter, x11Filter, tcpFilter);
    }
