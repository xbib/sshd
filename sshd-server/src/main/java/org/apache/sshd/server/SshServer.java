...
public class SshServer extends AbstractFactoryManager implements ServerFactoryManager, Closeable {
    ...
    public static WrappedForwardingFilter setupServerForwarding(SshServer server, PropertyResolver options) {
        WrappedForwardingFilter forwardFilter = SshServerConfigFileReader.resolveServerForwarding(options);
